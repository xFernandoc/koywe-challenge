...
describe('QuoteRepository', () => {
    ...
    describe('Crear usuario',  () => {
        ...
        it('Crear un usuario con error en la información',async () => {
            quotaModel.create.mockRejectedValue(new Error('Error por indice duplicado'))

            await expect(repository.create(mockQuote)).rejects.toThrow('Error por indice duplicado')
        })
    })
